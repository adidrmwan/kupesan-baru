...
<section class="flexslider-container" id="flexslider-container-6">
    <div class="flexslider slider tour-slider" id="slider-6">
        <ul class="slides">
            <li class="item-1 back-size" style="background:url(dist/images/bg-baru.png) 50% 65%; background-size:cover; height:100%; ">
               <div class="meta" >         
                    <div class="container" style="text-align: center;">
                        <span class="highlight-price highlight-2" style="font-size:22px; ">Capture the time of your life with</span>
                        <h2>KUPESAN.ID</h2>
                    </div>
                </div>
            </li>          
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="tab-content" style="border-radius: 15px;">
                        <!-- fotostudio -->
                        <div id="studio" class="tab-pane in active" style="border-radius: 15px;">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
                                        <div class="form-group right-icon" >
                                            <select  class="form-control" name="tag_id" required>
                                                <option selected value="">Pilih Spot</option>
                        ...
                        <div id="mua" class="tab-pane" style="border-radius: 15px;">
                            <form>
                                <div class="row">
                        ...
                        <!-- kebaya -->
                        <div id="kebaya" class="tab-pane" style="border-radius: 15px;">
...
<section id="studio-offers" class="section-padding bottom-padding" style="background:url(dist/images/bg-studio.png) 50% 65%; background-size:cover;">
    <div class="container" >
        <div class="row">
            <div class="col-sm-12">
                <div class="page-heading">
                    <h2 style="font-family: 'Italianno', cursive; font-size: 60px; background: linear-gradient(#FE9321, #FF6E6D);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">Spot Foto </h2>
                    <hr class="heading-line" />
                </div><!-- end page-heading -->
                
                <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-studio-offers">
                    @foreach($thumbnailSpot as $key => $data)
                            <div class="item">
                                ...
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                            ...
                                            <img src="{{ asset('logo/'.$data->pr_logo.'.JPG')  }}" class="img-responsive" alt="about-img" style="max-width: 100%; margin: 0 auto; height: 270px; width: auto; float: none; display: block;position: relative;" />
                                            @else
                                            <img src="dist/images/spot-home.png" class="img-responsive" alt="about-img" style="max-width: 100%; margin: 0 auto; height: 270px; width: auto; float: none; display: block;position: relative;" />
                                            @endif
                                    </div>
                    ...
                    @endforeach
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="#">
                                            <img src="dist/images/spot-home.png" class="img-responsive" alt="kebaya-img" />
                                        </a>
                                    </div>
                                    <div class="main-info tour-info">
                                        <div class="main-title tour-title">
                                            <a href=""> <b>Partner-KU</b></a>
                                            <p>Surabaya</p>
                                        </div>
                                    </div>
                                </div>
...
<section id="kebaya" class="section-padding bottom-padding" style="background:url(dist/images/bg-busana.png) 50% 65%; background-size:cover;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-heading">
                    <h2 style="font-family: 'Italianno', cursive; font-size: 60px; background: linear-gradient(#FE9321, #FF6E6D);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">Busana </h2>
                    <hr class="heading-line" />
                </div><!-- end page-heading -->
                <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-kebaya">
                    @foreach($thumbnailBusana as $key => $data)
                        <div class="item">
                            <a href="{{route('detail.kebaya', ['id' => $data->user_id])}}">
                            <div class="main-block tour-block">
                                <div class="main-img">
                                        @if(File::exists(public_path("logo/".$data->pr_logo.".jpg")))
                                        <img src="{{ asset('logo/'.$data->pr_logo.'.jpg')  }}" class="img-responsive" alt="about-img" style="max-width: 100%; margin: 0 auto; height: 270px; width: auto; float: none; display: block;position: relative; " />
                                        ...
                                        <img src="{{ asset('logo/'.$data->pr_logo.'.JPG')  }}" class="img-responsive" alt="about-img" style="max-width: 100%; margin: 0 auto; height: 270px; width: auto; float: none; display: block;position: relative;" />
                                        @else
                                        <img src="dist/images/busana-home.png" class="img-responsive" alt="about-img" style="max-width: 100%; margin: 0 auto; height: 270px; width: auto; float: none; display: block;position: relative;" />
                                        @endif
                                </div>
                                <div class="main-info tour-info">
                                    <div class="main-title tour-title">
                    ...
                    @endforeach
                        ...
                        <div class="item">
                            <div class="main-block tour-block">
                                <div class="main-img">
                                    <a href="#">
                                        <img src="dist/images/busana-home.png" class="img-responsive" alt="kebaya-img" />
                                    </a>
                                </div>
                                <div class="main-info tour-info">
                                    <div class="main-title tour-title">
...
<section id="fotografer-offers" class="section-padding bottom-padding" style="background:url(dist/images/bg-studio.png) 50% 65%; background-size:cover;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-heading">
...
<section id="mua-offers" class="section-padding bottom-padding" style="background:url(dist/images/bg-busana.png) 50% 65%; background-size:cover;">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-heading">
                    ...
                    <h2 style="font-family: 'Italianno', cursive; font-size: 60px; background: linear-gradient(#FE9321, #FF6E6D);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">Penata Rias</h2>
                    <hr class="heading-line" />
                </div><!-- end page-heading -->
...
<section class="innerpage-wrapper lightgrey-features parallax1" id="best-features">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">
                    <div id="abt-cnt-2-text">
                        <h2> <b> Bergabunglah Menjadi <span style="color:#FF6E6D"> PARTNER-KU </span> ! </b></h2>
                        <p>Temukan berbagai kemungkinan baru untuk terhubung dengan konsumen  dan mengembangkan usaha Anda  dengan <span style="color:#FF6E6D"><b>KUPESAN.ID</b> </span>.</p>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-10 col-lg-offset-1">
                                <div class="page-heading">
                                    <h2 style="font-family: 'Italianno', cursive; font-size: 60px; background: linear-gradient(#FE9321, #FF6E6D);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">Contact Us</h2>
                                    <hr class="heading-line" />
                                </div>
