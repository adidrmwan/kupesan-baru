                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" style="">
                                            <div class="form-group {{ $errors->has('birth_date') ? ' has-error' : '' }} "  >
                                                  <input id="birth_date" type="date" class="form-control" name="birth_date" placeholder="Birth Date" value="{{ old('birth_date') }}" data-date-format="yyyy-mm-dd" required style="border: none; outline: none; -webkit-appearance: textfield; min-height: 1px;" >
