...
<section class="page-cover " id="cover-hotel-detail" style="margin-top: 3.5%;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
...
<section id="studio" class="section-padding">
	...
	-webkit-text-fill-color: transparent;">Portofolio</h2>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="page-heading white-heading">
                          <h3 style="font-family: 'Italianno', cursive; font-size: 50px; background: linear-gradient(#FE9321, #FF6E6D);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">Feature / Amenities</h3>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                      <div class="page-heading white-heading">
                        <h3 style="font-family: 'Italianno', cursive; font-size: 50px; background: linear-gradient(#FE9321, #FF6E6D);
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;">Rules</h3>
                      </div>
                      <div class="row">
                        <table class="table">
