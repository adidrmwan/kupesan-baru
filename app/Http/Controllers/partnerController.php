...
class PartnerController extends Controller
{
    public function dashboard()
    {
        ...
        if ($partner->pr_type == '1') {
            ...
            elseif (!empty($fasilitas->facilities_id)) {
                $booking_unapprove = Booking::join('ps_package', 'ps_package.id', '=', 'booking.package_id')
                            ...
                            ->where('ps_package.user_id', $user->id)
        ...
        if ($partner->pr_type == '4') {
            $booking_unapprove = KebayaBooking::join('kebaya_product', 'kebaya_product.id', '=', 'kebaya_booking.package_id')
                            ...
                            ->select('kebaya_product.name','kebaya_product.set','kebaya_product.size','partner.pr_name','partner.pr_name','kebaya_booking.start_date', 'kebaya_booking.end_date','kebaya_booking.booking_id','kebaya_booking.package_id','kebaya_booking.booking_status', 'kebaya_booking.quantity', 'kebaya_booking.booking_total', 'kebaya_booking.booking_price', 'kebaya_booking.biaya_kirim', 'kebaya_booking.biaya_dry_clean', 'kebaya_booking.deposit', 'users.phone_number', 'users.email', 'kebaya_booking.updated_at', 'kebaya_booking_address.flag', 'kebaya_product.price_dryclean')
                            ->get();
            $biayaKirim = '10000';
    ...
    public function showStep1()
    {
        ...
        $package_carte = PSPkg::where('user_id', $partner->user_id)->where('pkg_category_them', 'A La Carte')
                            ->where('status', 1)->get();
        $package_package = PSPkg::where('user_id', $partner->user_id)->where('pkg_category_them', 'Special Package')
                            ->where('status', 1)->get();
        $package_studio = PSPkg::where('user_id', $partner->user_id)->where('pkg_category_them', 'Special Studio')
                            ->where('status', 1)->get();
    ...
    public function submitStep3(Request $request)
    {
        ...
        if (empty($bookingcheck2)) {
            ...
            $booking->partner_id = $packageI->user_id;
    ...
    public function submitFormDayOff(Request $request)
    {
        ...
        $package_dayoff = new PSPkg();
        $package_dayoff->user_id = $bookingcheck->package_id;
        ...
        for ($i=0; $i < $durasi_libur; $i++) { 
            ...
            foreach ($package as $key => $value) {
                $cek_booking_dayoff = BookingCheck::where('package_id', $value->id)->where('booking_date', $dayoff)->first();
                $flag = '0';
                if(!empty($cek_booking_dayoff->num_hour_1) && $cek_booking_dayoff->num_hour_1 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_2) && $cek_booking_dayoff->num_hour_2 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_3) && $cek_booking_dayoff->num_hour_3 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_4) && $cek_booking_dayoff->num_hour_4 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_5) && $cek_booking_dayoff->num_hour_5 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_6) && $cek_booking_dayoff->num_hour_6 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_7) && $cek_booking_dayoff->num_hour_7 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_8) && $cek_booking_dayoff->num_hour_8 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_9) && $cek_booking_dayoff->num_hour_9 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_10) && $cek_booking_dayoff->num_hour_10 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_11) && $cek_booking_dayoff->num_hour_11 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_12) && $cek_booking_dayoff->num_hour_12 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_13) && $cek_booking_dayoff->num_hour_13 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_14) && $cek_booking_dayoff->num_hour_14 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_15) && $cek_booking_dayoff->num_hour_15 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_16) && $cek_booking_dayoff->num_hour_16 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_17) && $cek_booking_dayoff->num_hour_17 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_18) && $cek_booking_dayoff->num_hour_18 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_19) && $cek_booking_dayoff->num_hour_19 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_20) && $cek_booking_dayoff->num_hour_20 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_21) && $cek_booking_dayoff->num_hour_21 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_22) && $cek_booking_dayoff->num_hour_22 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_23) && $cek_booking_dayoff->num_hour_23 == '1'){$flag = '1';}
                if(!empty($cek_booking_dayoff->num_hour_24) && $cek_booking_dayoff->num_hour_24 == '1'){$flag = '1';}
    ...
    {   
        ...
        $title = 'Libur';
        $events = [];
                $data = Booking::where('partner_id', $user->id)->get();
                // dd($data);
                if($data->count()) {
        ...
        $booking = Booking::join('ps_package', 'ps_package.id', '=', 'booking.package_id')
                        ->where('ps_package.user_id', $user->id)
                        ->where('booking.booking_status', 'offline-booking')
                        ->orWhere('booking.booking_status', 'confirmed')
                        ->where('ps_package.user_id', $user->id)
                        ->orderBy('booking.booking_start_date', 'asc')->get();
    ...
    {   
        ...
        $booking = Booking::join('ps_package', 'ps_package.id', '=', 'booking.package_id')
                        ...
                        ->orwhere('booking.booking_status', 'completed')
                        ->where('ps_package.user_id', $user->id)
                        ->orderBy('booking.booking_start_date', 'asc')->get();
    ...
    {   
        ...
        $booking2 = Booking::where('booking_id', $booking_id)->first();
        $package_id->booking_start_date = Carbon::now();
        $booking_start_date = date('Y-m-d', strtotime("$booking2->booking_start_date"));
        ...
        return view('partner.ps.detail-booking', ['partner' => $partner, 'booking' => $booking, 'package' => $package], compact('flag_date'));
    }
